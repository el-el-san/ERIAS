...
import { ProjectTask, ProjectStatus, UserFeedback, ProjectInfo } from '../types/agentTypes';
import { mapProjectStatusToTaskState, calculateProgressFromStatus, generateProgressBar } from '../agent/utils/progressUtils';
